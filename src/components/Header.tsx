...
export default function Header() {
	const { isMenuOpen, setIsMenuOpen } = useContext(Context) as IContext;
		...
		>
			<div className="flex justify-between items-center">
				<div className="flex items-center gap-4 cursor-pointer p-1">
					<button
						className="text-xl cursor-pointer transition-all duration-300 hover:bg-white/10 p-2 rounded-full flex md:hidden"
